...
from scripts.distillation.dataset_transforms import TransposeImage, ToTensor, DivisiblePad, ZedDataset
...
class FoundationStereoEvaluator:
    def __init__(self, config_txt, root_dir, args):
        ...
        return
    def init_model(self, args, logger):
