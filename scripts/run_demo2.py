...
if __name__=="__main__":
  ...
  if args.remove_invisible:
    ...
    disp[invalid] = 0
    os.makedirs('/media/levin/DATA/nerf/new_es8/stereo/250610/disp', exist_ok=True)
    np.save(f'/media/levin/DATA/nerf/new_es8/stereo/250610/disp/{file_name}.npy', disp)
    logging.info(f"Disparity map saved to /media/levin/DATA/nerf/new_es8/stereo/250610/disp/{file_name}.npy")
