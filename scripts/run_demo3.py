...
if __name__ == "__main__":
    ...
    folder = '/media/levin/DATA/nerf/public_depth/kitti12/training'
    # file_name = '20250331_111635.913_10.png'
    file_name = '000000_10.png'

    # big hole
    # folder = '/media/levin/DATA/nerf/new_es8/stereo_20250331/20250331/lidar'
    # file_name = '00000062.png'

    args.left_file = f"{folder}/colored_0/{file_name}"
    args.right_file = f"{folder}/colored_1/{file_name}"
    ...
    if args.remove_invisible:
        disp_folder = f"{folder}/disp"
        os.makedirs(disp_folder, exist_ok=True)
        np.save(
            f'{disp_folder}/{file_name}.npy', disp)
        logging.info(
            f"Disparity map saved to {disp_folder}/{file_name}.npy")
